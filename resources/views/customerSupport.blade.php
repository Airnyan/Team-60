...
<x-layout>
    ...
    <div class="container mx-auto px-4 pt-10">
        ...
        <!--Heading-->
        <h3 class="text-3xl text-neutral-content py-4 mb-2 font-semibold mt-8">FAQS SECTION</h3>
        ...
        <!--Heading-->
        <h3 class="text-3xl text-neutral-content py-4 mb-2 font-semibold mt-8">CONTACT FORM</h3>
